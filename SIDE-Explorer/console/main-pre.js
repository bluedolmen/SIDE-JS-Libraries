  ...
  */
	...
	SIDE.params.init = function() {
		...
		if (SIDE.Util.getParam('login') != 'default') {
			...
			SIDE.params.mainSIDEView = SIDE.params.prompt('mainSIDEView', 'Main SIDE view?', 'http://localhost:8080/alfresco/service/com/bluexml/side/view/K/Ouvrage_DataList.json');
			...
			SIDE.params.mainSIDEView = 'http://localhost:8080/alfresco/service/com/bluexml/side/view/K/Ouvrage_DataList.json';
			SIDE.params.viewService = SIDE.params.prompt('viewService', 'View Service?', 'http://cloud.bluexml.com/grid-with-preview/index.jsp');
			SIDE.params.dataNsp = SIDE.params.prompt('dataNsp', 'Data namespace', 'K')
			SIDE.params.viewNsp = SIDE.params.prompt('viewNsp', 'View namespace', SIDE.params.dataNsp)
		}
