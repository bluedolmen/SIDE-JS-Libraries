...
<head>
		...
		<script type="text/javascript" src="yamma2-4-log.js"></script>
		<script type="text/javascript" src="yamma2-4-layout.js"></script>
		...
		<script type="text/javascript" src="yamma2-4-main.js"></script>
